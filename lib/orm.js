...
ORM.prototype.define = function (model, fields, colParams) {
	...
	Model.hasOne = function () {
		...
		associationHelpers.one.create(this, association, model);
	};
	Model.hasMany = function () {
		...
		associationHelpers.many.create(this, association, field, model);
	};
	Model.sync = function () {
...
module.exports = {
	...
	"connect"   : function (/* uri_or_dbtype, [db_object], cb */) {
		var rawDb, cb, uri, dbType, url = require("url");
